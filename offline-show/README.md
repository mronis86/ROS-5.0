...
2. **Requires [Node.js 20+](https://nodejs.org/)** on the show laptop (22 LTS recommended; Current/26+ is OK with this package). First run needs internet for `npm install` (SQLite prebuilds).

...
-- Run this migration on Neon to enable the Admin page backup config section.

CREATE TABLE IF NOT EXISTS admin_backup_config (
...
COMMENT ON TABLE admin_backup_config IS 'Single-row config for admin features e.g. Google Drive weekly backup';

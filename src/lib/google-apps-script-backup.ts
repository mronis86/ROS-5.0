/**
 * ROS 5.0 – Weekly backup script for Google Apps Script.
 * Paste this into script.google.com (New project). Keep in sync with docs/ros-weekly-backup-to-drive.gs
 */
export const GOOGLE_APPS_SCRIPT_BACKUP_SOURCE = `/**

-- User Sessions and Role Tracking Schema
-- This tracks authenticated users, their current run of show, and their role

-- Create user_sessions table to track active user sessions
CREATE TABLE IF NOT EXISTS user_sessions (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
    event_id UUID NOT NULL, -- References the run of show/event they opened
...
-- Function to cleanup inactive sessions (older than 24 hours)

-- Simple fix for sub-cue timer database functions
-- Drop conflicting functions and recreate with correct parameters

-- Drop all existing sub-cue timer functions
...
BEGIN
    -- Get user info from the timer being stopped

-- Simple fix for log_change function uniqueness error
-- This will drop ALL existing log_change functions and create a single definitive one

-- Drop ALL existing log_change functions using a simpler approach
DROP FUNCTION IF EXISTS log_change CASCADE;

-- Create the single, definitive log_change function

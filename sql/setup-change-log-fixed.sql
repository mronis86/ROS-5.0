-- Fixed setup script for change log tracking
-- Run this in your Supabase SQL editor

-- Create change_log table
CREATE TABLE IF NOT EXISTS change_log (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    event_id TEXT NOT NULL, -- Changed from UUID to TEXT to match existing data
...
-- Create RLS policies (fixed to handle TEXT event_id)
...
-- Create the main logging function (fixed parameter types)
...
-- Create function to get change log (fixed parameter types)

    ...
    try {
      ...
      try {
        r =
          filter === 'all'
            ? await pool.query(
                `SELECT a.id, a.neon_user_id, a.email, a.full_name, a.status, a.is_admin, a.requested_at, a.reviewed_at, a.reviewed_by, a.notes, a.password_set_at, a.portal_token,

 ...
 *   OPS_ALERT_UNAUTHORIZED_SPA_MAX=500  — higher bar for Netlify/OBS/localhost (missing or expired session)
...
/**
 * Our Netlify/localhost SPA (including OBS Browser Sources) hitting protected
 * routes with a missing OR expired session. Not an external scanner — referer
 * + normal browser/OBS UA. Spoofable, so we still count, but email only at a
